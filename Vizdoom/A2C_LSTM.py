...
def a2c_lstm(input_shape, action_size, value_size, learning_rate):
    ...
    x = TimeDistributed(Conv2D(32, 8, 8, strides=(
        4, 4), activation='relu'))(state_input)
    x = TimeDistributed(
...
class A2CAgent:
    ...
    def train_model(self):
        ...
        loss = self.model.fit(
            state_inputs, [advantages, discounted_rewards], nb_epoch=1, verbose=0)
